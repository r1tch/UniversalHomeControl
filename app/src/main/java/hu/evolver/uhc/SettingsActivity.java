...
// TODO if connect detail chg, new intent to reconnect!
    ...
    public static class ConnectionPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (activity instanceof SettingsActivity) {
                ((SettingsActivity)activity).bindPreferenceSummaryToValue(findPreference("pref_hostname"));
                ((SettingsActivity)activity).bindPreferenceSummaryToValue(findPreference("pref_port"));
            }
        }
    ...
    public static class DisplayPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            // TODO if grouping method changed, initiate redraw
//            ((SettingsActivity)activity)bindPreferenceSummaryToValue(findPreference("notifications_new_message_ringtone"));
        }
